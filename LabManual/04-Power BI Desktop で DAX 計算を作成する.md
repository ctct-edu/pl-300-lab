...
1. この演習を完了するには、まず Web ブラウザーを開き、次の URL を入力して zip フォルダーをダウンロードします。
    ...
    以前のラボ実施状態が保持されている場合はそこから引き続き実施できます。以前のラボの実施状態が失われている、完了していない場合は **04-Starter-Sales Analysis.pbix** ファイルを開いてラボを開始します。
...
1. **[テーブル ツール]** コンテキスト リボンの **[日付テーブルとしてマーク]** を選択します。

1. **[日付テーブルとしてマーク]** ウィンドウの **[日付テーブルとしてマーク]** をオンにしてから **[日付列を選択する]** ドロップダウン リストで **[日付]** を選択します。 **[OK]** を選択します。
