...
1. この演習を完了するには、まず Web ブラウザーを開き、次の URL を入力して zip フォルダーをダウンロードします。
    ...
    以前のラボ実施状態が保持されている場合はそこから引き続き実施できます。以前のラボの実施状態が失われている、完了していない場合は **05-Starter-Sales Analysis.pbix** ファイルを開いてラボを開始します。
...
1. 視覚エフェクトを書式設定するには、 **[視覚化]** ペインにある **[ビジュアルの書式設定]** を選択します。

1. **[検索]** ボックスに「**レイアウト**」と入力します。

1. **[マトリックスレイアウト]** の **[レイアウト]** プロパティを **[表形式]** に設定します。
...
1. 次の式に基づいて、**Sales** テーブルにメジャーを追加します。
     ...
     *"このラボのDAX 定義は、**C:\Users\ctct\Downloads\\05-modify-dax-filter-context\\05-Snippets.txt** ファイルからコピーできます。"*
...
2. 次の式に基づいて、**Sales** テーブルに新しいメジャーを追加します。小数点以下 0 桁に書式設定します。
