...
1. Microsoft Edge ブラウザー ウィンドウの Power BI サービスの **[ナビゲーション]** ペインで、**[マイ ワークスペース]** を展開します。 Microsoft Edge ブラウザー ウィンドウを開いたままにします。
     ...
     ![画像 22](./image/07/07-my-workspace-new.png)
...
1. スライサーを **[Overview]** ページおよび **[Profit]** ページと同期します。
     ...
     ![画像 94](./image/07/08-design-report-in-power-bi-desktop-enhanced_image15.png)
...
1. 視覚化の書式オプションを構成してから、**[カテゴリ ラベル]** プロパティを **[オフ]** にします。
     ...
     ![画像 103](./image/07/07-design-report-in-power-bi-desktop_image36b.png)

1. **[効果] > [背景色]** プロパティを、''白、20% 暗い'' などの灰色の薄い網掛けに設定します。**

     ![画像 103](./image/07/07-design-report-in-power-bi-desktop_image36c.png)
...
1. 中央のルールを削除するには、黄色の三角形の右側にある **[X]** を選択します。
     ...
     ![画像 109](./image/07/08-design-report-in-power-bi-desktop-enhanced_image31.png)
...
1. **[ブックマーク]** ペインで、**[追加]** を選択します。
    ...
    *ブックマークの名前を変更するには、ブックマークをダブルクリックします。*
     ...
     ![画像 121](./image/07/08-design-report-in-power-bi-desktop-enhanced_image42.png)
...
1. **[挿入]** リボンの **[要素]** グループ内の **[ボタン]** を選択し、**[空白]** を選択します。
     ...
     ![画像 125](./image/07/08-design-report-in-power-bi-desktop-enhanced_image48.png)

1. **Year** スライサーの真下にボタンを配置します。

1. ボタンを選択し、 **[ボタンの書式設定]** ペインで、 **[ボタン]** を選び、 **[スタイル]** セクションを展開し、 **[テキスト]** プロパティを **[オン]** にします。

     ![画像 126](./image/07/08-design-report-in-power-bi-desktop-enhanced_image49b.png)
